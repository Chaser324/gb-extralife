...
(function() {
  ...
  initComplete = function() {
    var channel, channelEntry, isLive, key, randomUser, specifiedCount, streamNumber, value;
    specifiedCount = 0;
    for (key in specifiedParams) {
      value = specifiedParams[key];
      if (value === true) {
  ...
  layoutPlayerSlot = function(slot) {
    var channelEntry, chatLink, gbUserName, layout, number, overlay, player;
  ...
  $(window).load(function() {
    ...
    initEvents();
    initPage();
    return setTimeout(initComplete, 3000);
  });
