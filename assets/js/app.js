...
refreshStream = function(channel) {
  return $.ajax({
    ...
    success: function(data) {
      ...
      if (stream === null) {
        return channelEntry.find('p.live').removeClass('on-air');
      } else {
