...
initPage = function() {
  var initLayout, key, param1, param2, param3, value;
...
refreshStream = function(channel) {
  return $.ajax({
    ...
    success: function(data) {
      var channelEntry, isLive, stream;
      stream = data["stream"];
...
refreshOnAirCount = function() {
  if (onAirStreamCount > 0) {
    return $('.liveStreamCount').html(onAirStreamCount + ' Streams Are <span class="on-air-count">LIVE!</span>');
  } else {
    return $('.liveStreamCount').html('Live Streams');
  }
};
...
layoutPlayerSlot = function(slot) {
  var layout, number, overlay, player;
...
loadChat = function(channel) {
  ...
  if ((channel !== currentChat) && (channel !== 'irc')) {
