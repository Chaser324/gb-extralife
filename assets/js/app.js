...
initIndex = function() {
  ...
  $('.index-entry').each(function() {
    return refreshStream($(this).attr('data-channel'));
  });
  return setTimeout(refreshAlerts, 10000);
};
...
refreshAlerts = function() {
  ...
  if (newAlerts.length === 0) {
    ...
    return $('#liveAlerts').fadeIn('fast', function() {
      return alertTextBox.hide().html(alertStr).fadeIn('fast').delay(3000).fadeOut('fast', function() {
...
refreshStream = function(channel) {
  return $.ajax({
    ...
    success: function(data) {
      var alertStr, channelEntry, currentGame, gbUserName, isLive, stream;
      stream = data["stream"];
