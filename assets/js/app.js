...
(function() {
  ...
  initPage = function() {
    var first_visit, initLayout, key, param1, param2, param3, paramSpecified, value;
  ...
  layoutPlayerSlot = function(slot) {
    var chatLink, layout, number, overlay, player;
  ...
  window.loadChat = function(channel) {
    if (channel !== currentChat) {
      ...
      return $("#chatnav ul li a[data-chat='" + channel + "']").addClass('active');
    }
  };
  ...
  $(window).load(function() {
    ...
    return $('#streamsLoading').fadeOut('fast', function() {
      ...
      $('#info-content').show();
      $('#info-navbar').show();
      return $('#streams-wrapper').fadeIn('slow', function() {
        return doResize();
      });
    });
  });
